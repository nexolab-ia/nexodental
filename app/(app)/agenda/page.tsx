...
export default async function AgendaPage() {
  ...
  const [professionals, boxes, availability, patients, organization] = await runAsTenant(sql, actor, async (tx) => Promise.all([
  ...
  return <main><AgendaClient professionals={enrichedProfessionals} boxes={boxes} patients={agendaPatients} blockDuration={blockDuration} initialAppointments={initialAppointments} initialDate={initialDate} /></main>;
}
